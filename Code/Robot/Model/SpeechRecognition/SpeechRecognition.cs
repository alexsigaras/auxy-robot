...
namespace HumanoidRobot.Model.SpeechRecognition
{
    public static class SoundRecognition
    {
        ...
        /// Step 3- Converts flac file to byte array to send to google
        ...
        /// <param name="sampleRate">Rate</param>
        /// <returns>recognized string</returns>
        /// Step 4- Sends .flac as converted byte array to google and returns string 
